...
# create a publisher
blink_publisher = rospy.Publisher('/safety/blink_rate', Float64, queue_size=10)
...
# load video/stream
cap = cv2.VideoCapture("/home/cares/catkin_ws/src/careslab_dvrk_safety/Blink_3secs.mp4")
